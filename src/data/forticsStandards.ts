...
export const DEFAULT_WORKFLOW_SCHEMA_TEMPLATE: ForticsWorkflow = {
  ...
  flow: [
    ...
    },
    {
      ...
      __spec_version: "1.0.0",
      method: "POST",
      uri: "https://api.empresa-exemplo.com.br/v1/auth/token",
      verify_ssl: true,
      body_format: "json",
    ...
    },
    {
      ...
      __spec_version: "1.0.0",
      method: "GET",
      uri: "https://api.empresa-exemplo.com.br/v1/agendamentos?retornarCancelados=false&retornarProdutos=true",
      verify_ssl: true,
      headers: [{ key: "Authorization", value: "Bearer {{token.access_token}}" }],
      query_params: [
...
- Finalização de proposta transborde para #HUMANO`,
  ...
  {
    id: "template-financeiro-provedor",
    ...
    workflow: {
      ...
      flow: [
        ...
        },
        {
          ...
          __spec_version: "1.0.0",
          method: "GET",
          uri: "https://api.exemplo-sgg.com.br/api/v3/funcionario?paginador[pagina]=0&paginador[tamanho]=100&cpf={{request.cpf}}",
          verify_ssl: true,
          body_format: "json",
          body: "{\n\"key\": \"value\"\n}",
          headers: [
        ...
        },
        {
          ...
          __spec_version: "1.0.0",
          method: "GET",
          uri: "https://api.exemplo-sgg.com.br/api/v3/empresa",
          verify_ssl: true,
          body_format: "json",
          body: "{\n\"key\": \"value\"\n}",
          headers: [
        ...
        },
        {
          ...
          __spec_version: "1.0.0",
          method: "POST",
          uri: "https://api.exemplo-sgg.com.br/api/v3/demissao/",
          verify_ssl: true,
          body_format: "json",
    ...
    workflow: {
      ...
      flow: [
        ...
        },
        {
          ...
          __spec_version: "1.0.0",
          method: "POST",
          uri: "https://api.exemplo-clinica.com.br/oauth/v1/token",
          verify_ssl: true,
          body_format: "json",
          body: "{\n\"key\": \"value\"\n}",
          headers: [
        ...
        },
        {
          ...
          __spec_version: "1.0.0",
          method: "GET",
          uri: "https://api.exemplo-clinica.com.br/api/v1/integration/insurance-providers",
          verify_ssl: false,
          body_format: "json",
          body: "{\n\"key\": \"value\"\n}",
          headers: [
        ...
        },
        {
          ...
          __spec_version: "1.0.0",
          method: "GET",
          uri: "https://api.exemplo-clinica.com.br/api/v1/integration/facilities/1/patients",
          verify_ssl: false,
          body_format: "json",
          body: "{\n\"key\": \"value\"\n}",
          headers: [
        ...
        },
        {
          ...
          __spec_version: "1.0.0",
          method: "GET",
          uri: "https://api.exemplo-clinica.com.br/api/v1/integration/facilities/1/doctors?filter_web_disabled=false",
          verify_ssl: true,
          body_format: "json",
          body: "{\n\"key\": \"value\"\n}",
          headers: [
        ...
        },
        {
          ...
          __spec_version: "1.0.0",
          method: "GET",
          uri: "https://api.exemplo-clinica.com.br/api/v1/integration/facilities/1/doctors/{{doutores_filtrados.id}}/addresses/1/available-slots",
          verify_ssl: true,
          body_format: "json",
          body: "{\n\"key\": \"value\"\n}",
          headers: [
        ...
        },
        {
          ...
          __spec_version: "1.0.0",
          method: "POST",
          uri: "https://api.exemplo-clinica.com.br/api/v1/integration/facilities/1/doctors/{{doutores_filtrados.id}}/addresses/1/slots/{{hora_escolhida}}",
          verify_ssl: true,
          body_format: "json",
    ...
    workflow: {
      ...
      flow: [
        ...
        },
        {
          ...
          __spec_version: "1.0.0",
          method: "POST",
          uri: "https://api.exemplo-erp.com.br/connect/token",
          verify_ssl: true,
          body_format: "file",
        ...
        },
        {
          ...
          __spec_version: "1.0.0",
          method: "POST",
          uri: "https://api.exemplo-erp.com.br/pbx/pbx/events/new/CLIENT_VALIDATE",
          verify_ssl: false,
          body_format: "json",
    ...
    workflow: {
      ...
      flow: [
        ...
        },
        {
          ...
          __spec_version: "1.0.0",
          method: "POST",
          uri: "https://api.exemplo-central.com.br/api/central/chamado/",
          verify_ssl: true,
          body_format: "json",
    ...
    workflow: {
      ...
      flow: [
        ...
        },
        {
          ...
          __spec_version: "1.0.0",
          method: "POST",
          uri: "https://api.exemplo-governo.com.br/ws/statelessws.php",
          verify_ssl: true,
          body_format: "raw",
...
export const REAL_LOOPING_WORKFLOWS: Array<{
      ...
      flow: [
        {
          ...
          __spec_version: "1.0.0",
          method: "POST",
          uri: "https://app.genier.ai/empresa_exemplo/workflow/consultar_token",
          verify_ssl: true,
          body_format: "json",
          body: ""
        },
        ...
        },
        {
          ...
          __spec_version: "1.0.0",
          method: "GET",
          uri: "https://api.exemplo-erp.com.br/external/Integrations/thirdparty/getopentitlesbyexpirationdate?page={{definir_pagina_da_rodada.pagina_atual}}&pageSize=200",
          verify_ssl: false,
          ...
          then: [
            {
              ...
              __spec_version: "1.0.0",
              method: "POST",
              uri: "https://api.sz.chat/api/v4/message/send",
              verify_ssl: true,
              body_format: "json",
  ...
  {
    id: "wf-loop-2-agendamento-48h-clinica_exemplo",
        ...
        },
        {
          ...
          then: [
          ...
          else: [
            {
              ...
              __spec_version: "1.0.0",
              method: "POST",
              uri: "https://app.genier.ai/clinica_exemplo/godb/api/collections/Agendamentos/records",
              verify_ssl: false,
              body_format: "json",
    ...
    workflow: {
      ...
      flow: [
        ...
        },
        {
          ...
          __spec_version: "1.0.0",
          method: "GET",
          uri: "https://api.empresa-exemplo.com.br/v1/agendamentos?retornarCancelados=false&retornarProdutos=true&codigosEmpresa=3",
          verify_ssl: true,
          headers: [{ key: "Authorization", value: "Bearer {{token.access_token}}" }]
        },
        {
          ...
          else: [
            {
              ...
              then: [
              ...
              else: [
                {
                  ...
                  __spec_version: "1.0.0",
                  method: "POST",
                  uri: "https://app.genier.ai/empresa_exemplo/godb/api/collections/Agendamentos/records",
                  verify_ssl: false,
                  body_format: "json",
